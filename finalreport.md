...
Possible merging of multiple datasets. Where to find the missing information? Our own data scraping? Keeping features like titles, movie credits, and keywords and including some language parsing. Not including all languages. What if there were outlier languages with high popularities? Expanding out movie dates to full quarters? Consider median or other methods for dealing with missing values.
